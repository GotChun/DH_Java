...
//		int a=10;int b=20;
//		System.out.println((a>=b)&&(a>5));		//둘다 참이어야함 첫번째 거짓이면 뒤는 보지도 않음
...
//		System.out.println(score + "점은 " + grade + "등급입니다.");
		...
		System.out.println("점수입력하셈 ::");
		int korean = sc.nextInt();
		int eng= sc.nextInt();
		int math= sc.nextInt();

		int a= 40;
		double sum = (double)(korean+eng+math)/3;
		String grade = (korean>=a&&eng>=a&&math>=a&&sum>=70) ? "합격" : "불합격";
		System.out.printf("%f 점은 %s 등급입니다",sum,grade);
		System.out.printf("%f 점은 %s 등급입니다",sum,grade);
		//소수점 자르려면 math.round() 함수 이용
